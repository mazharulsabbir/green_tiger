  ...
  Widget build(BuildContext context) {
    return CommonLoadingOverlay(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            const CommonSeconderyAppBar(title: 'Add Address'),
            SizedBox(
              height: Get.height * 0.86,
              child: SingleChildScrollView(
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 30, horizontal: 12.0),
                  child: Form(
                    key: _formKey,
                    child: Column(
                      ...
                      children: [
                        ...
                        //TODO: #3 `Country or Region` DropdownFormField overflowing at the edge.
                        DropdownButtonFormField<Country>(
                          validator:
                              ShippingAddressValidations.dropdownValidation,
                        ...
                        TextFormField(
                          ...
                          validator:
                              ShippingAddressValidations.firstNameValidate,
                        ),
                        const SizedBox(height: 10),
                        Text(
                          'Last Name',
                        ...
                        TextFormField(
                          ...
                          textCapitalization: TextCapitalization.words,
                          validator:
                              ShippingAddressValidations.lastNameValidate,
                        ),
                        const SizedBox(height: 10),
                        Text(
                          'Street Address',
                        ...
                        TextFormField(
                          controller: street1Controller
                            ..text =
                                controller.defaultAddress?.streetAddress1 ?? '',
                          decoration: textInputDecoration,
                          textCapitalization: TextCapitalization.words,
                          validator:
                        ...
                        TextFormField(
                          controller: street2Controller
                            ..text =
                                controller.defaultAddress?.streetAddress2 ?? '',
                          decoration: textInputDecoration,
                          textCapitalization: TextCapitalization.words,
                          validator:
                        ...
                        TextFormField(
                          ...
                          validator:
                              ShippingAddressValidations.zipCodeValidation,
                        ),
                        const SizedBox(height: 10),
                        Text(
                          'Phone Number',
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if ((_formKey.currentState != null) &&
                                ...
                                await controller
                                    .saveDefaultAddress(shippingAddress);
                                Get.back();
                              }
                            },
                            child: const Text(
